...
$tutorial.append('You wake up days later with no equipment or belongings. Your surroundings are unfamiliar. There is no sign of your companion or the evil wizard anywhere. The world seems to be shattered into chunks, each piece of the world randomly swapped with another. You see off in the distance trees next to tundra, cities next to dungeons, forests in the middle of lakes. One thing is certain, You need to find your companion and ensure that amulet doesn\'t fall into that wizard\'s hands. Your best bet is to find the nearest town and get your bearings straight.<br><br>');
