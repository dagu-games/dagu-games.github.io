...
var updateDetails = function () {
    ...
    str += "Temperature: " + world[details_i][details_j].temperature + "<br>";
    str += "Precipitation: " + world[details_i][details_j].precipitation + "<br>";
    str += "Wind: " + world[details_i][details_j].wind + "<br>";
    ...
    if (world[details_i][details_j].type === "town") {
        if(world[details_i][details_j].size != null){
            ...
            str += "<h2>" + world[details_i][details_j].name + "</h2>";
            str += "<button onclick=\"user_interface.generateTownButton()\">Generate Town Data</button>";
        }
    }else if(world[details_i][details_j].type === "dungeon"){
        str += "Dungeon Creator: " + world[details_i][details_j].dungeon_creator + "<br>";
        str += "Dungeon Location: " + world[details_i][details_j].dungeon_location + "<br>";
        str += "Dungeon Purpose: " + world[details_i][details_j].dungeon_purpose + "<br>";
        str += "Dungeon History: " + world[details_i][details_j].dungeon_history + "<br>";
    }
...
var generateWorld = function () {
    ...
    for (let i = 0; i < len; i++) {
        for (let j = 0; j < len; j++) {
            if (world[i][j].terrain === "grassland" && world[i][j].type !== "town" && util.getRandomInt(data.settings.dungeon_chance) == 0) {
                world[i][j].type = "dungeon";
                world[i][j].dungeon_location = util.getRandomValueInArray(data.dungeon_locations);
